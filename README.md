...
**🏠 Aduino UNO Board를 사용한 스마트 홈 (TEAM) 🔎 _[깃허브](https://github.com/ccchaeng.git)_**

- *2023.11.03 ~ 2023.11.29*

- 온도센서를 이용해 일정 온도 이하로 내려가면 보일러(LED) 켜주기, 인체감지센서를 이용해 현관 위의 LED 켜주기, 초음파센서를 이용해 차량이 들어오면 피에조 스피커를 통해 소리 내주며 주차 완료 시 LED 켜주기, 스위치 누르면 집 안의 LED 조명 켜주기, 스위치 눌러 커튼 열고 닫기

- 기술 스택: Aduino IDE 2.3.4, C++

  - 개발 기획
  - 인체감지 센서를 이용해 현관 위의 LED 센서등 켜주는 아두이노 보드 및 코드 구현
  - 스위치를 눌러 집 안의 LED 조명 켜주는 아두이노 보드 및 코드 구현
