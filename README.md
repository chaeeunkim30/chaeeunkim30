...
- 송/수신자가 사전에 서로 동일한 키를 공유(대칭키 암호 시스템)해야 하며, 임의로 만들어 놓은 알파벳 색상 표를 가지고 알파벳에 맞는 색상과 키를 합성해 암호문을 만들 수 있는 시스템입니다.
<br>

**🐱 고양이 아케이드 퍼즐 게임 🔎 _[깃허브](https://github.com/chaeeunkim30/Basic-Of-VRAR-Game-Production.git)_**

- *2023.11.08 ~ 2023.11.28*
- 주인이 외출한 사이 고양이가 방 안을 돌아다니며 여기저기 흩어져 있는 고양이의 보물(먹이)을 찾아 다양한 퀴즈를 풀며 보물을 얻는 아케이드 퍼즐 게임입니다.
